...
class FilmCategoryMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./film_category.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./film_category.policy').acl);
  }


  async default (req, res, next) {

    console.log('FilmCategory middleware;')
...
module.exports = FilmCategoryMiddleware;