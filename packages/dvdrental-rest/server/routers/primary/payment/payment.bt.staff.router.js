...
class PaymentBtStaffRouter extends BaseRouter {

  constructor(app) {
    super(app);
    this.PaymentMiddleware = app.$middlewares.primary.PaymentMiddleware;
    this.PaymentBtStaffService = app.$services.primary.PaymentBtStaffService;
    this._mapRoutes(app.$router);
  }


  async belongs(req, res) {
    let data = await this.PaymentBtStaffService.belongsTo(req, res);
    res.json(data);
  }
...
module.exports = PaymentBtStaffRouter;